...
|COSC 5500 <br> <b> Visual Analytics </b> | I learn making dashboard with tools like Tableau. Check out my [Tableau Dashboard](https://public.tableau.com/views/DibalokeChandaVisualAnalyticsSpring2024TableauProject_3/Dashboard1?:language=en-GB&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link). As a final project, I used Rshiny to create an interactive app, see the GitHub repo for that.|
